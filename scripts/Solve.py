...
def solve(TESTCASE, SETTINGS):
    ...
    Returns:
        None
    """
    #  PART 1, STEP 0 - Initialize all the model classes in the models directory (models/) and familiarize
    ...
    flat_start = SETTINGS['Flat Start']
    ...
    # Assign node indices for remaining devices
    ...
    #  PART 1, STEP 1 - Complete the function to initialize your solution vector v_init.
    v_init = initialize(size_Y, bus, generator, slack, flat_start)
